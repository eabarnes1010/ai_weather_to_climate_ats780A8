...
np.save(
    os.path.join(output_data_dir, "output_upper_" + str(0)),
    input,
)
np.save(
    os.path.join(output_data_dir, "output_surface_" + str(0)),
    input_surface,
)
...
for i in range(28):
    ...
    # Your can save the results here
    np.save(
        os.path.join(output_data_dir, "output_upper_" + str(i + 1)),
        output,
    )
    np.save(
        os.path.join(output_data_dir, "output_surface_" + str(i + 1)),
        output_surface,
    )
